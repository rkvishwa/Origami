    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <div className="mx-auto max-w-[1600px] px-4 py-6 sm:px-6">
        <section className="mb-6 rounded border border-white/10 bg-[#0A0A0A] p-5">
          ...
          <div className="mt-6 rounded border border-white/10 bg-white/[0.02] p-5 transition-all focus-within:border-lime-500/50 focus-within:ring-1 focus-within:ring-lime-500/50">
            <textarea
