...
export function SiteNavbar() {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-white/10 bg-black/60 px-6 backdrop-blur-xl">
      ...
      <Link
        href="/workspace"
        className="inline-flex items-center gap-2 rounded-full bg-lime-300 px-4 py-1.5 text-sm font-semibold text-black transition-all hover:bg-lime-200 hover:shadow-[0_0_16px_rgba(163,230,53,0.35)]"
      >
        Open Workspace
